  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Future<void> setupWallet() async {
      try {
        ...
        // address discovery
        final client = ref.read(spectreClientProvider);
        final api = ref.read(spectreApiServiceProvider);
        ...
        if (network == SpectreNetwork.mainnet && !introData.generated) {
              ...
              child: Column(
                ...
                children: [
                  FractionallySizedBox(
                    ...
                    child: FittedBox(
                      fit: BoxFit.fitWidth,
                      child: Image.asset('assets/spectre.png'),
                    ),
                  ),
                  Column(
                    children: [
