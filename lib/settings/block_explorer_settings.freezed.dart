...
mixin _$BlockExplorerSettings {
  Map<SpectreNetwork, BlockExplorer> get selection =>
...
abstract class $BlockExplorerSettingsCopyWith<$Res> {
  ...
  @useResult
  $Res call({Map<SpectreNetwork, BlockExplorer> selection});
}
    ...
    return _then(_value.copyWith(
      selection: null == selection
          ...
          : selection // ignore: cast_nullable_to_non_nullable
              as Map<SpectreNetwork, BlockExplorer>,
    ) as $Val);
  }
}
...
class _$BlockExplorerSettingsImpl extends _BlockExplorerSettings {
  const _$BlockExplorerSettingsImpl(
      {final Map<SpectreNetwork, BlockExplorer> selection = const {
  ...
  final Map<SpectreNetwork, BlockExplorer> _selection;
  @override
  @JsonKey()
  Map<SpectreNetwork, BlockExplorer> get selection {
...
abstract class _BlockExplorerSettings extends BlockExplorerSettings {
  const factory _BlockExplorerSettings(
          {final Map<SpectreNetwork, BlockExplorer> selection}) =
      _$BlockExplorerSettingsImpl;
