...
AddressPrefix addressPrefixForNetwork(SpectreNetwork network) {
  switch (network) {
...
abstract class HdWallet implements HdWalletView {
  ...
  static String hdPublicKeyFromSeed(
    ...
    final child = bip32.derivePath(kSpectreDerivationPath);
...
class HdWalletEcdsa extends HdWallet {
  ...
  HdWalletEcdsa(Uint8List seed) : super._() {
    _bip32 = BIP32.fromSeed(seed).derivePath(kSpectreDerivationPath);
  }
