...
///  GetCurrentNetworkRequestMessage requests the network spectred is currently running against.
///
...
/// GetPeerAddressesRequestMessage requests the list of known spectred addresses in the
...
/// currently connected to this spectred.
...
class GetConnectedPeerInfoMessage extends $pb.GeneratedMessage {
  ...
  /// Whether this spectred initiated the connection
  @$pb.TagNumber(6)
  ...
  /// The timestamp of when this peer connected to this spectred
  @$pb.TagNumber(10)
...
/// AddPeerRequestMessage adds a peer to spectred's outgoing connection list.
/// This will, in most cases, result in spectred connecting to said peer.
...
/// GetBlockCountRequestMessage requests the current number of blocks in this spectred.
...
///  See: UtxosChangedNotificationMessage
///
///  This message only exists for backward compatibility reason with spectred and is deprecated.
...
///  GetUtxosByAddressesRequestMessage requests all current UTXOs for the given spectred addresses
///
///  This call is only available when this spectred was started with `--utxoindex`
