...
class SpectredRequest extends $pb.GeneratedMessage {
  factory SpectredRequest({
    $fixnum.Int64? id,
  ...
  SpectredRequest._() : super();
  factory SpectredRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SpectredRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, SpectredRequest_Payload> _SpectredRequest_PayloadByTag = {
    1001 : SpectredRequest_Payload.getCurrentNetworkRequest,
    1003 : SpectredRequest_Payload.submitBlockRequest,
    1005 : SpectredRequest_Payload.getBlockTemplateRequest,
    1007 : SpectredRequest_Payload.notifyBlockAddedRequest,
    1010 : SpectredRequest_Payload.getPeerAddressesRequest,
    1012 : SpectredRequest_Payload.getSinkRequest,
    1014 : SpectredRequest_Payload.getMempoolEntryRequest,
    1016 : SpectredRequest_Payload.getConnectedPeerInfoRequest,
    1018 : SpectredRequest_Payload.addPeerRequest,
    1020 : SpectredRequest_Payload.submitTransactionRequest,
    1022 : SpectredRequest_Payload.notifyVirtualChainChangedRequest,
    1025 : SpectredRequest_Payload.getBlockRequest,
    1027 : SpectredRequest_Payload.getSubnetworkRequest,
    1029 : SpectredRequest_Payload.getVirtualChainFromBlockRequest,
    1031 : SpectredRequest_Payload.getBlocksRequest,
    1033 : SpectredRequest_Payload.getBlockCountRequest,
    1035 : SpectredRequest_Payload.getBlockDagInfoRequest,
    1037 : SpectredRequest_Payload.resolveFinalityConflictRequest,
    1039 : SpectredRequest_Payload.notifyFinalityConflictRequest,
    1043 : SpectredRequest_Payload.getMempoolEntriesRequest,
    1045 : SpectredRequest_Payload.shutdownRequest,
    1047 : SpectredRequest_Payload.getHeadersRequest,
    1049 : SpectredRequest_Payload.notifyUtxosChangedRequest,
    1052 : SpectredRequest_Payload.getUtxosByAddressesRequest,
    1054 : SpectredRequest_Payload.getSinkBlueScoreRequest,
    1056 : SpectredRequest_Payload.notifySinkBlueScoreChangedRequest,
    1059 : SpectredRequest_Payload.banRequest,
    1061 : SpectredRequest_Payload.unbanRequest,
    1063 : SpectredRequest_Payload.getInfoRequest,
    1065 : SpectredRequest_Payload.stopNotifyingUtxosChangedRequest,
    1067 : SpectredRequest_Payload.notifyPruningPointUtxoSetOverrideRequest,
    1070 : SpectredRequest_Payload.stopNotifyingPruningPointUtxoSetOverrideRequest,
    1072 : SpectredRequest_Payload.estimateNetworkHashesPerSecondRequest,
    1074 : SpectredRequest_Payload.notifyVirtualDaaScoreChangedRequest,
    1077 : SpectredRequest_Payload.getBalanceByAddressRequest,
    1079 : SpectredRequest_Payload.getBalancesByAddressesRequest,
    1081 : SpectredRequest_Payload.notifyNewBlockTemplateRequest,
    1084 : SpectredRequest_Payload.getMempoolEntriesByAddressesRequest,
    1086 : SpectredRequest_Payload.getCoinSupplyRequest,
    1088 : SpectredRequest_Payload.pingRequest,
    1090 : SpectredRequest_Payload.getMetricsRequest,
    1092 : SpectredRequest_Payload.getServerInfoRequest,
    1094 : SpectredRequest_Payload.getSyncStatusRequest,
    1096 : SpectredRequest_Payload.getDaaScoreTimestampEstimateRequest,
    1100 : SpectredRequest_Payload.submitTransactionReplacementRequest,
    1102 : SpectredRequest_Payload.getConnectionsRequest,
    1104 : SpectredRequest_Payload.getSystemInfoRequest,
    1106 : SpectredRequest_Payload.getFeeEstimateRequest,
    1108 : SpectredRequest_Payload.getFeeEstimateExperimentalRequest,
    1110 : SpectredRequest_Payload.getCurrentBlockColorRequest,
    0 : SpectredRequest_Payload.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SpectredRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'protowire'), createEmptyInstance: create)
  ...
  SpectredRequest clone() => SpectredRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SpectredRequest copyWith(void Function(SpectredRequest) updates) => super.copyWith((message) => updates(message as SpectredRequest)) as SpectredRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SpectredRequest create() => SpectredRequest._();
  SpectredRequest createEmptyInstance() => create();
  static $pb.PbList<SpectredRequest> createRepeated() => $pb.PbList<SpectredRequest>();
  @$core.pragma('dart2js:noInline')
  static SpectredRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SpectredRequest>(create);
  static SpectredRequest? _defaultInstance;

  SpectredRequest_Payload whichPayload() => _SpectredRequest_PayloadByTag[$_whichOneof(0)]!;
...
class SpectredResponse extends $pb.GeneratedMessage {
  factory SpectredResponse({
    $fixnum.Int64? id,
  ...
  SpectredResponse._() : super();
  factory SpectredResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SpectredResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, SpectredResponse_Payload> _SpectredResponse_PayloadByTag = {
    1002 : SpectredResponse_Payload.getCurrentNetworkResponse,
    1004 : SpectredResponse_Payload.submitBlockResponse,
    1006 : SpectredResponse_Payload.getBlockTemplateResponse,
    1008 : SpectredResponse_Payload.notifyBlockAddedResponse,
    1009 : SpectredResponse_Payload.blockAddedNotification,
    1011 : SpectredResponse_Payload.getPeerAddressesResponse,
    1013 : SpectredResponse_Payload.getSinkResponse,
    1015 : SpectredResponse_Payload.getMempoolEntryResponse,
    1017 : SpectredResponse_Payload.getConnectedPeerInfoResponse,
    1019 : SpectredResponse_Payload.addPeerResponse,
    1021 : SpectredResponse_Payload.submitTransactionResponse,
    1023 : SpectredResponse_Payload.notifyVirtualChainChangedResponse,
    1024 : SpectredResponse_Payload.virtualChainChangedNotification,
    1026 : SpectredResponse_Payload.getBlockResponse,
    1028 : SpectredResponse_Payload.getSubnetworkResponse,
    1030 : SpectredResponse_Payload.getVirtualChainFromBlockResponse,
    1032 : SpectredResponse_Payload.getBlocksResponse,
    1034 : SpectredResponse_Payload.getBlockCountResponse,
    1036 : SpectredResponse_Payload.getBlockDagInfoResponse,
    1038 : SpectredResponse_Payload.resolveFinalityConflictResponse,
    1040 : SpectredResponse_Payload.notifyFinalityConflictResponse,
    1041 : SpectredResponse_Payload.finalityConflictNotification,
    1042 : SpectredResponse_Payload.finalityConflictResolvedNotification,
    1044 : SpectredResponse_Payload.getMempoolEntriesResponse,
    1046 : SpectredResponse_Payload.shutdownResponse,
    1048 : SpectredResponse_Payload.getHeadersResponse,
    1050 : SpectredResponse_Payload.notifyUtxosChangedResponse,
    1051 : SpectredResponse_Payload.utxosChangedNotification,
    1053 : SpectredResponse_Payload.getUtxosByAddressesResponse,
    1055 : SpectredResponse_Payload.getSinkBlueScoreResponse,
    1057 : SpectredResponse_Payload.notifySinkBlueScoreChangedResponse,
    1058 : SpectredResponse_Payload.sinkBlueScoreChangedNotification,
    1060 : SpectredResponse_Payload.banResponse,
    1062 : SpectredResponse_Payload.unbanResponse,
    1064 : SpectredResponse_Payload.getInfoResponse,
    1066 : SpectredResponse_Payload.stopNotifyingUtxosChangedResponse,
    1068 : SpectredResponse_Payload.notifyPruningPointUtxoSetOverrideResponse,
    1069 : SpectredResponse_Payload.pruningPointUtxoSetOverrideNotification,
    1071 : SpectredResponse_Payload.stopNotifyingPruningPointUtxoSetOverrideResponse,
    1073 : SpectredResponse_Payload.estimateNetworkHashesPerSecondResponse,
    1075 : SpectredResponse_Payload.notifyVirtualDaaScoreChangedResponse,
    1076 : SpectredResponse_Payload.virtualDaaScoreChangedNotification,
    1078 : SpectredResponse_Payload.getBalanceByAddressResponse,
    1080 : SpectredResponse_Payload.getBalancesByAddressesResponse,
    1082 : SpectredResponse_Payload.notifyNewBlockTemplateResponse,
    1083 : SpectredResponse_Payload.newBlockTemplateNotification,
    1085 : SpectredResponse_Payload.getMempoolEntriesByAddressesResponse,
    1087 : SpectredResponse_Payload.getCoinSupplyResponse,
    1089 : SpectredResponse_Payload.pingResponse,
    1091 : SpectredResponse_Payload.getMetricsResponse,
    1093 : SpectredResponse_Payload.getServerInfoResponse,
    1095 : SpectredResponse_Payload.getSyncStatusResponse,
    1097 : SpectredResponse_Payload.getDaaScoreTimestampEstimateResponse,
    1101 : SpectredResponse_Payload.submitTransactionReplacementResponse,
    1103 : SpectredResponse_Payload.getConnectionsResponse,
    1105 : SpectredResponse_Payload.getSystemInfoResponse,
    1107 : SpectredResponse_Payload.getFeeEstimateResponse,
    1109 : SpectredResponse_Payload.getFeeEstimateExperimentalResponse,
    1111 : SpectredResponse_Payload.getCurrentBlockColorResponse,
    0 : SpectredResponse_Payload.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SpectredResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'protowire'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SpectredResponse clone() => SpectredResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SpectredResponse copyWith(void Function(SpectredResponse) updates) => super.copyWith((message) => updates(message as SpectredResponse)) as SpectredResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SpectredResponse create() => SpectredResponse._();
  SpectredResponse createEmptyInstance() => create();
  static $pb.PbList<SpectredResponse> createRepeated() => $pb.PbList<SpectredResponse>();
  @$core.pragma('dart2js:noInline')
  static SpectredResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SpectredResponse>(create);
  static SpectredResponse? _defaultInstance;

  SpectredResponse_Payload whichPayload() => _SpectredResponse_PayloadByTag[$_whichOneof(0)]!;
  void clearPayload() => clearField($_whichOneof(0));
