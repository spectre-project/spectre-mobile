...
class SpectredMessage extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, SpectredMessage_Payload> _SpectredMessage_PayloadByTag = {
    ...
    1022 : SpectredMessage_Payload.notifyVirtualSelectedParentChainChangedRequest,
    1023 : SpectredMessage_Payload.notifyVirtualSelectedParentChainChangedResponse,
    ...
    1030 : SpectredMessage_Payload.getVirtualSelectedParentChainFromBlockResponse,
    ...
    1056 : SpectredMessage_Payload.notifyVirtualSelectedParentBlueScoreChangedRequest,
    1057 : SpectredMessage_Payload.notifyVirtualSelectedParentBlueScoreChangedResponse,
    1058 : SpectredMessage_Payload.virtualSelectedParentBlueScoreChangedNotification,
    ...
    1070 : SpectredMessage_Payload.stopNotifyingPruningPointUTXOSetOverrideRequest,
    1071 : SpectredMessage_Payload.stopNotifyingPruningPointUTXOSetOverrideResponse,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SpectredMessage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protowire'), createEmptyInstance: create)
  ...
  factory SpectredMessage.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SpectredMessage.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  ...
  'Will be removed in next major version')
  SpectredMessage copyWith(void Function(SpectredMessage) updates) => super.copyWith((message) => updates(message as SpectredMessage)) as SpectredMessage; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SpectredMessage create() => SpectredMessage._();
  SpectredMessage createEmptyInstance() => create();
  static $pb.PbList<SpectredMessage> createRepeated() => $pb.PbList<SpectredMessage>();
  @$core.pragma('dart2js:noInline')
  static SpectredMessage getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SpectredMessage>(create);
  static SpectredMessage? _defaultInstance;

  SpectredMessage_Payload whichPayload() => _SpectredMessage_PayloadByTag[$_whichOneof(0)]!;
