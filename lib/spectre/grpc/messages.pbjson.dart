...
@$core.Deprecated('Use spectredMessageDescriptor instead')
const SpectredMessage$json = const {
  '1': 'SpectredMessage',
  '2': const [
    const {
      '1': 'addresses',
...
/// Descriptor for `SpectredMessage`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List spectredMessageDescriptor = $convert.base64Decode(
