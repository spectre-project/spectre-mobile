...
class WalletAuthNotifier extends StateNotifier<WalletAuth> {
  ...
  Future<String> _getSeed() async {
    ...
    return SpectreUtil.decryptHex(secret, sessionKey);
  }
  ...
  Future<Uint8List> sign(
    ...
    final signature =
        await SpectreUtil.computeSignDataSchnorr(data, keyPair.privateKey);
    return signature;
  }
  ...
  Future<void> unlockWithPassword(String password) async {
    ...
    final sessionKey = await walletVault.getSessionKey();
    final encryptedSecret = SpectreUtil.encryptHex(seed, sessionKey);
  ...
  HdAddressGenerator addressGenerator(SpectreNetwork network) {
