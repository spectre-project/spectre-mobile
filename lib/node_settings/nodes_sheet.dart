...
class SpectreNodesSheet extends ConsumerWidget {
  const SpectreNodesSheet({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final items = ref.watch(spectreNodeOptionsProvider);
          ...
          ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return ProviderScope(
                overrides: [
                  spectreNodeConfigItemProvider.overrideWithValue(config),
                ],
