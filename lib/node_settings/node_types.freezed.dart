...
mixin _$NodeConfig {
  ...
  SpectreNetwork get network => throw _privateConstructorUsedError;
...
abstract class _NodeConfig extends NodeConfig {
  const factory _NodeConfig(
      ...
      final bool isSecure,
      required final List<String> urls,
      required final SpectreNetwork network}) = _$NodeConfigImpl;
