...
class BuySettingItem extends SettingSelectionItem {
  ...
  String getDisplayName(BuildContext context) {
    ...
    return l10n.buySpectreSubtitle;
  }
}
...
class BuySheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    void buySpectre() {
      ...
      final uri = Uri.https('Spectre-topper.vercel.app', '/api/topper', {
        'source': source,
        'target': 'SPR',
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Text(
                l10n.buySpectreMessage + '\n' + l10n.buySpectreMessageSecondary,
