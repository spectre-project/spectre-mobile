...
import '../spectre/types.dart';
import '../l10n/l10n.dart';
import '../themes/spectrum_light_theme.dart';
...
class MainCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final spectreBalance = ref.watch(formatedTotalBalanceProvider);
    final fiatBalance = ref.watch(formatedTotalFiatProvider);
    final spectrePrice = ref.watch(formatedSpectrePriceProvider);
    ...
    Future<void> scanQrCode() async {
      ...
      final uri = SpectreUri.tryParse(data, prefix: prefix);
                      ...
                      Container(
                        child: FittedBox(
                          ...
                          child: Row(
                            children: [
                              Image.asset(
                                'assets/spectre_transparent_180.png',
                                width: 30,
                                color: theme is SpectrumLightTheme
                                    ? theme.primary
                                    : null,
                              ),
